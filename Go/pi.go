...
//  USAGE:
// type "go run pi.go [iterations]" into terminal/prompt
// or build with "go build pi.go" and execute with "./pi.exe [iterations]" on windows and "./pi [iterations]" on linux
package main
